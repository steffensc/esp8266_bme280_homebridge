...
"<label>SSID:</label>"
"<input id='ssid' name='ssid' length=31 value='%s'>"
"<br>"
"<label>PASS:</label>"
"<input name='pass' length=63 value='%s'>"
"<br>"
"<label>SENSOR NO.:</label>"
"<input name='sensorno' length=2 value='%s'>"
"<br>"
"<label>Temp. Bias:</label>"
"<input name='tempbias' length=5 value='%s'>"
"<label>Humi. Bias:</label>"
"<input name='humibias' length=5 value='%s'>"
"<br><br>"
"<input type='submit'>"
"</form>"
"<br><br>"
